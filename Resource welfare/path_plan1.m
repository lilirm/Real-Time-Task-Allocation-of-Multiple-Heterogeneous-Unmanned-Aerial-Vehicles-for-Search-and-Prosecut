function [uav,target,sumE] = path_plan1(attack_target,coalition,cost,uav,target,l,maxUavId)  %attack_taregt/coalition为编号 added 2020/5/26
...
for i=1:length(coalition)
    ...
    [uav(coalition(i)),tempE] = dubins_path_plan_energy(uav(coalition(i)),target(attack_target),radius);
    sumE = sumE+tempE;
end
end
