function [uav] = border_process_energy(uav,l,b,time_interval)  %uav特定无人机
border = zeros(2,2);
% border(1,1) = -l/2;
% border(1,2) = l/2;
% border(2,1) = -b/2;
...
if type ~= -1
    ...
    if hudu1 > hudu2
        uav = border_path_plan_energy(c2,hudu2,direction2,uav,time_interval);
    else
        uav = border_path_plan_energy(c1,hudu1,direction1,uav,time_interval);
    end
end
