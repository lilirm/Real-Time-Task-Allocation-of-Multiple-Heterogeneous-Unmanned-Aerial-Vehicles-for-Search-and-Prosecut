function [coalition,cost,maxUavId] = formcoalition4(uav,target,attack_target,target_candidate)
...
[coalition,coalitionCost] = resourcetree_target(target_candidate,target_candidate_cost,uav,target,attack_target);
